...
- [ ] **T-001** — Add the `BetStrategy` type and `pickStrategy`
...
- [ ] **T-002** — Point `suggestStakeForOdds` at `BetStrategy`
  - Files: `src/domain/ledger.ts`
...
- [ ] **T-003** — Add the required `strategy` field to `Bet` and add `stampBets`
  - Files: `src/domain/ledger.ts`
...
- [ ] **T-004** — Price each recorded bet from its own strategy
  - Files: `src/domain/ledger.ts`
...
- [ ] **T-005** — Keep guardrails on live settings
  - Files: `src/domain/ledger.ts`
...
- [ ] **T-010** — Stamp bets loaded from local storage
  - Files: `src/App.tsx`
...
- [ ] **T-011** — Stamp imported workbook bets
...
- [ ] **T-013** — Read and write the cloud columns
...
- [ ] **T-020** — Stamp on create, preserve on edit
  - Files: `src/App.tsx`
...
- [ ] **T-021** — Show the recorded strategy in the bet form
...
- [ ] **T-030** — Steps for recorded values and unchanged figures
...
- [ ] **T-054** — Demo ledger figures verified unchanged against the pre-change app
